...
Besides the activities related to the implementation and evaluation pertaining to the three defined topics % (T1, T2, and T3), % of algorithms, 
we will also write deliverables, reports, and %research 
